...
const News_home = () => {
  ...
  useEffect(() => {
    fetch(
      "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCupvZG-5ko_eiXAupbDfxWw&maxResults=5&order=date&key=AIzaSyC9xzdwpLokZiHo9JFXFpTHFVoLCu1o5ak"
    )
    ...
    fetch(
      "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UC16niRr50-MSBwiO3YDb3RA&maxResults=5&order=date&key=AIzaSyC9xzdwpLokZiHo9JFXFpTHFVoLCu1o5ak"
    )
      .then((response) => response.json())
      .then((data) => {
